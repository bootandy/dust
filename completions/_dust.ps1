...
Register-ArgumentCompleter -Native -CommandName 'dust' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'dust' {
            ...
            [CompletionResult]::new('--no-leader-lines', '--no-leader-lines', [CompletionResultType]::ParameterName, 'No dotted leader lines drawn between the filename and its percent bar')
