...
set edit:completion:arg-completer[dust] = {|@words|
    ...
    var completions = [
        &'dust'= {
            ...
            cand -S 'Deprecated. The walker no longer recurses so a custom stack size is unnecessary. Accepted for compatibility but the value is ignored'
            cand --stack-size 'Deprecated. The walker no longer recurses so a custom stack size is unnecessary. Accepted for compatibility but the value is ignored'
